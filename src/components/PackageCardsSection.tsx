...
import { Check, ArrowRight, Phone, ShieldCheck, Sparkles } from 'lucide-react';
  ...
  const packages = [
    {
      ...
      highlight: false,
      priceDescription: 'Free Custom Quote',
      ...
      ctaLink: '/residential-gutter-cleaning',
    },
    {
      ...
      ctaText: 'Choose Deep Clean',
      ctaLink: '/gutter-and-downspout-cleaning',
    },
    {
      ...
      ctaText: 'Explore Commercial Plan',
      ctaLink: '/commercial-gutter-cleaning',
    },
  ];
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <div className="pt-2">
            <a
              ...
              className="inline-flex items-center gap-2 bg-blue-50 hover:bg-blue-100 text-brand-blue border border-blue-200 px-4 py-2 rounded-full text-xs font-bold transition-colors"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch max-w-7xl mx-auto">
          {packages.map((pkg, idx) => (
            ...
            >
              ...
              {/* Action Buttons: Primary + Call Option */}
              <div className="pt-2 space-y-2.5">
                <Link
                  ...
                  className={`w-full py-3.5 px-6 rounded-2xl font-bold text-sm text-center flex items-center justify-center gap-2 transition-all shadow-md ${
                    pkg.highlight
                      ? 'bg-brand-blue hover:bg-brand-blue-hover text-white shadow-brand-blue/30 hover:shadow-brand-blue/50'
                      : 'bg-slate-900 hover:bg-black text-white hover:shadow-lg'
                  }`}
                >
                ...
                <a
                  href={COMPANY_CONFIG.phoneTel}
                  className={`w-full py-2.5 px-4 rounded-xl text-xs font-bold text-center flex items-center justify-center gap-2 border transition-all ${
                    pkg.highlight
                      ? 'border-slate-700 text-slate-300 hover:text-white hover:bg-white/10'
